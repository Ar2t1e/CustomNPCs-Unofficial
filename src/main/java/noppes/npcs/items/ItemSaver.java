...
public class ItemSaver extends Item implements INPCToolItem, ISpecBuilder {

    public ItemSaver() { super((new Item.Properties()).stacksTo(1)); }
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nullable Level worldIn, @Nonnull List<Component> list, @Nonnull TooltipFlag flagIn) {
        ...
        if (builder != null) {
            list.add(Component.translatable("info.item.saver"));
            for (int i = 7; i <= 8; i++) {
