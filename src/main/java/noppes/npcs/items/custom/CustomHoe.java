...
public class CustomHoe extends ItemHoe implements ICustomElement {
    ...
    public CustomHoe(float attackDamageIn, float attackSpeedIn, Item.ToolMaterial materialIn, Set<Block> effectiveBlocksIn, @Nonnull NBTTagCompound nbtItem) {
        super(materialIn);
        nbtData = nbtItem;
        ...
        if (nbtItem.hasKey("ToolClass", 8)) { ((IItemToolMixin) this).setToolClass("hoe"); }
