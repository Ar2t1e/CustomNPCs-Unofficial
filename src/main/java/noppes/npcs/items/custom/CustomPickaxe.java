...
implements ICustomElement {
	...
	public CustomPickaxe(float attackDamageIn, float attackSpeedIn, Item.ToolMaterial materialIn, Set<Block> effectiveBlocksIn, @Nonnull NBTTagCompound nbtItem) {
		super(materialIn);
		nbtData = nbtItem;
		...
		if (nbtItem.hasKey("ToolClass", 8)) { ((IItemToolMixin) this).setToolClass("pickaxe"); }
