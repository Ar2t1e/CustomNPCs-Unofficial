...
public class CustomAxe extends ItemAxe implements ICustomElement {
    ...
    public CustomAxe(float attackDamageIn, float attackSpeedIn, Item.ToolMaterial materialIn, Set<Block> effectiveBlocksIn, @Nonnull NBTTagCompound nbtItem) {
        super(materialIn, attackDamageIn, attackSpeedIn);
        nbtData = nbtItem;
