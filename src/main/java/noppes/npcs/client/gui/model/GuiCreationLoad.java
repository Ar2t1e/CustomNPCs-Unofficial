...
public class GuiCreationLoad extends GuiCreationScreenInterface<ContainerLayer> implements ICustomScrollListener {
	...
	public void initGui() {
		...
		add(scroll.setPos(guiLeft, guiTop + 45)
				.setList(list)
				.setSize(100, ySize - 96));
		addButton(10, guiLeft, guiTop + ySize - 46, "gui.remove")
				.setSize(120, 20);
	}
