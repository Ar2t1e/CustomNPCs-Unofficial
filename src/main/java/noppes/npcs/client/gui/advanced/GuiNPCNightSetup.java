...
public class GuiNPCNightSetup extends GuiNPCInterface2 implements IGuiData {
   ...
   public void buttonEvent(GuiButtonNop button) {
      switch (button.id) {
         ...
         case 10: data.editingModus = ((GuiButtonYesNo) button).getBoolean(); save(); init(); break;
   ...
   @Override
   public void save() { Packets.sendServer(new SPacketMenuSave(EnumMenuType.TRANSFORM, data.saveOptions(new CompoundTag()))); }
