...
public class SubGuiNpcAvailabilityDialog
   ...
   public void buttonEvent(GuiButtonNop button) {
      switch (button.id) {
         case 0: {
            ...
            Dialog dialog = DialogController.instance.dialogs.get(id);
            if (dialog == null) { ((MutableComponent) select).append(Component.translatable("quest.notfound").withStyle(ChatFormatting.DARK_RED)); }
            else {
               ((MutableComponent) select).append(Component.translatable(dialog.getCategory().getName() + "/").withStyle(ChatFormatting.GRAY))
                       .append(Component.literal(dialog.getName()).withStyle(ChatFormatting.RESET))
                       .append(Component.literal(" (").withStyle(ChatFormatting.GRAY))
   ...
   public void subGuiClosed(Screen subgui) {
      ...
      ((MutableComponent) select).append(Component.translatable(selector.selectedCategory.getName() + "/").withStyle(ChatFormatting.GRAY))
              .append(Component.literal(selector.selectedDialog.getName()).withStyle(ChatFormatting.RESET))
              .append(Component.literal(" (").withStyle(ChatFormatting.GRAY))
