...
public class GuiBlockCopy
   ...
   public GuiBlockCopy(BlockPos posIn) {
      ...
      tile = (TileCopy) player.level().getBlockEntity(posIn);
   ...
   public void buttonEvent(GuiButtonNop button) {
      if (button.id == 0) { Packets.sendServer(new SPacketSchematicsStore(getTextField(5).getValue(), 0, tile.saveWithFullMetadata())); }
      onClose();
   }
