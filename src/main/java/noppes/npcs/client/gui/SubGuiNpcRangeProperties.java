...
public class SubGuiNpcRangeProperties extends GuiBasic implements ITextfieldListener {
   ...
   public void init() {
      ...
      // indirect
      y += 22;
      MutableComponent hover = Component.translatable("stats.hover.availability")
              .append(Component.translatable("stats.hover.availability." + ranged.getFireType(),
                      Util.instance.getOldFormattedText(Component.translatable("" + fireType[ranged.getFireType()])),
   ...
   public void subGuiClosed(Screen subgui) {
      if (subgui instanceof SubGuiSoundSelection gui && gui.resource != null) {
         soundSelected.setValue(gui.resource.toString());
