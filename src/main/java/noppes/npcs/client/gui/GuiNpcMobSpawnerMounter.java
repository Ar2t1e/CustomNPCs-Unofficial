		...
		switch (button.id) {
			case 1: {
				...
				switch (showingClones) {
					case 0: Packets.sendServer(new SPacketToolMounter(0, ClientCloneController.Instance.getCloneData(player, sel, activeTab))); break;
			...
			case 5: showingClones = 2; initGui(); break;
