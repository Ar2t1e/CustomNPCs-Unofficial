...
public class AnimationHandler {
   ...
   public static void animateBipedPre(ModelData ignoredData, HumanoidModel<? extends LivingEntity> bipedModel, LivingEntity livingEntity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   public static void animateBipedPost(ModelData data, HumanoidModel<? extends LivingEntity> bipedModel, LivingEntity livingEntity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (bipedModel instanceof PlayerModel<? extends LivingEntity> playerModel) {
