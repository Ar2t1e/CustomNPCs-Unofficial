...
public class ModelOBJPlayerArmor extends ModelBiped {
	...
	public void reset(EntityLivingBase entity) {
		...
		if (headItem.getItem() instanceof CustomArmor &&
				((CustomArmor) headItem.getItem()).objModel != null &&
		...
		if (chestItem.getItem() instanceof CustomArmor) {
			LogWriter.info("[DEBUG] objModel "+objModel);
			LogWriter.info("[DEBUG] chestItem "+chestItem.getItem());
			LogWriter.info("[DEBUG] item objModel "+((CustomArmor) chestItem.getItem()).objModel);
		}
		if (chestItem.getItem() instanceof CustomArmor &&
				((CustomArmor) chestItem.getItem()).objModel != null &&
		...
		if (legsItem.getItem() instanceof CustomArmor &&
				((CustomArmor) legsItem.getItem()).objModel != null &&
		...
		if (feetItem.getItem() instanceof CustomArmor &&
				((CustomArmor) feetItem.getItem()).objModel != null &&
