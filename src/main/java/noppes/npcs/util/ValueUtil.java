...
public class ValueUtil {
   ...
   public static float correctFloat(float given, float min, float max) { return Mth.clamp(given, min, max); }

   public static double correctDouble(double given, double min, double max) { return Mth.clamp(given, min, max); }

   public static int correctInt(int given, int min, int max) { return Mth.clamp(given, min, max); }
