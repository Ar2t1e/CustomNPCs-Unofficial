...
public interface IMethods {
    ...
    String getTextReducedNumber(@ParamName("value") double value, @ParamName("isInteger") boolean isInteger,
								@ParamName("color") boolean color, @ParamName("notPfx") boolean notPfx);
