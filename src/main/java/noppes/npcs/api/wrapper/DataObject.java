...
public class DataObject implements IDataObject {
	...
	public final List<IDataElement> elements = new ArrayList<>();
	...
	public String toString() {
		...
		if (!list.isEmpty()) {
			...
			for (IDataElement element : list) {
				if (!names.toString().isEmpty()) { names.append(", "); }
	...
	private void addTabs(StringBuilder line, int tabs) {
		while (tabs >= 0) { line.append(" "); tabs--; }
	}
