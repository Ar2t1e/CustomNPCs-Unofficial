...
public class Data implements IData {
    ...
    private static final NBTWrapper NBT_EMPTY = new NBTWrapper(new CompoundTag());
    ...
    public INbt getNbt() {
        ...
        if (cacheNbt == null) {
            cacheNbt = NBT_EMPTY;
            Tag tag = Util.instance.writeObjectToNbt(map);
            if (tag instanceof CompoundTag) { cacheNbt = new NBTWrapper((CompoundTag) tag); }
        }
