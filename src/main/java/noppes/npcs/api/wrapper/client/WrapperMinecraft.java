...
implements IMinecraft {
	...
	private final IRenderSystem glStateManager;
	private final IClientMouse iMouse = new WrapperMouse();
	
	public WrapperMinecraft(Minecraft mc) {
		minecraft = mc;
		glStateManager = new WrapperGlStateManager(mc);
	}
	...
	@Override
	public IRenderSystem getRenderSystem() { return this.glStateManager; }
