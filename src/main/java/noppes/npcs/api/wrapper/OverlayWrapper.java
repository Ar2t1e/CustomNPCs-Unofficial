...
public class OverlayWrapper implements IOverlay {
   ...
   public void load(INbt iNbt) {
      ...
      components.clear();
      ListTag list = iNbt.getMCNBT().getList("components", 10);
