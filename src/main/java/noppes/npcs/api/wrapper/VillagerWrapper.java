...
public class VillagerWrapper<T extends EntityVillager> extends EntityLivingWrapper<T> implements IVillager<T> {
	...
	@Override
	public String getCareer() { return this.entity.getProfessionForge().getCareer(EntityVillagerReflection.getCareerID(entity)).getName(); }

	@Override
	@SuppressWarnings("deprecation")
	public int getProfession() { return this.entity.getProfession(); }

	@Override
	public MerchantRecipeList getRecipes(IPlayer<?> player) { return this.entity.getRecipes(player.getMCEntity()); }

	@Override
	public int getType() { return EntityType.VILLAGER.get(); }

	@Override
	public IInventory getVillagerInventory() { return this.entity.getVillagerInventory(); }
