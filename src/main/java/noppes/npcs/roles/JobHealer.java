...
public class JobHealer extends JobInterface implements IJobHealer {
	...
	private boolean isEnemy(EntityLivingBase entity) {
		if (entity instanceof EntityPlayer && npc != null) { return npc.faction.isAggressiveToPlayer((EntityPlayer) entity); }
		else if (entity instanceof EntityNPCInterface && npc != null) { return npc.faction.isAggressiveToNpc((EntityNPCInterface) entity); }
