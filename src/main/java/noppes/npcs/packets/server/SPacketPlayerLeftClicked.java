...
public class SPacketPlayerLeftClicked extends PacketServerBasic {
   ...
   public static void encode(SPacketPlayerLeftClicked ignoredMsg, FriendlyByteBuf ignoredBuf) { }

   public static SPacketPlayerLeftClicked decode(FriendlyByteBuf ignoredBuf) { return new SPacketPlayerLeftClicked(); }
