...
public class SPacketDimensionRestore extends PacketServerBasic {
    ...
    public SPacketDimensionRestore() { }

    public SPacketDimensionRestore(int dimensionIn) { dimension = dimensionIn; }
    ...
    protected void handle() {
        ...
        DimensionController.getInstance().restoreDimension(player, dimension);
