...
public class SPacketPermissionGlobalGet extends PacketServerBasic {
    ...
    protected void handle() {
        ...
        Packets.send(player, new PacketPermissionGlobal(
                CustomNpcsPermissions.hasPermission(player, CustomNpcsPermissions.ADMIN),
                ...
                CustomNpcsPermissions.hasPermission(player, CustomNpcsPermissions.GLOBAL_PERMISSION)
        ));
